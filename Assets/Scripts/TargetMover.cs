	...
	void Update () {
		...
		switch(motionState) {
			...
			case motionDirections.Horizontal:
				...
				gameObject.transform.Translate(Vector3.right * Mathf.Cos(Time.timeSinceLevelLoad) * motionMagnitude*direction);
				break;
			case motionDirections.Vertical:
				// move up and down over time
			gameObject.transform.Translate(Vector3.up * Mathf.Cos(Time.timeSinceLevelLoad) * motionMagnitude*direction);
				break;
		}
	}
